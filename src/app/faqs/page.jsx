    ...
    <main className="relative flex justify-center min-h-screen bg-[#edd4cd]">
      <section className="top-4 p-8 text-gray-800 max-w-5xl">
        ...
        <p className="text-lg mb-12">
          Curious to know more about Lau's Paws? Whether you're wondering about our vaccination
          requirements or want to find out about pricing, here are the answers to some of the
